"
The following app does a bunch of things: allows users to customize the plot, 
subsets and samples the data, reports simple summary statistics, and displays 
the data table. Use HTML tags to add headers and visual separators to make it a
bit more clear, at a first glance, what's happening in the app.

In these exercises, use the convenient shortcuts for common HTML tags, like br() 
instead of tags$br().
"
